---
title: "串口协议使用说明书-PC端版本（Created by EtherealTide）"
date: 2025-07-09
permalink: /posts/2025/07/serial-protocol-pc/
tags:
  - 全国大学生电子设计竞赛
  - 串口协议
  - 嵌入式开发
...
collection: posts
---
- **Download source code**: [ET_serial-protocol_pc.py]({{ site.url }}{{ site.baseurl }}/files/serial_protocol_pc.py){:download="serial_protocol_pc.py"}
<!-- 保留你的原始内容 -->
